from voiture import Voiture # on peut ajouter un alias en cas de classe doublon: "as Car", à coté de Voiture
...
# v1 affiche "voiture.Voiture object at 0x7fef1ecfc910" si la fonction __str__() n'est pas définie
print(v1)
# Il faut pas afficher directement ces variables car elles sont considérées comme si elles étaient privées.
# C-à-d qu'elles sont toutes préfixées d'un underscore "_"
