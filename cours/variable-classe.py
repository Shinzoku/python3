...
# sinonlecture d'une variable de classe
print('chaise1.nombre_pied:', chaise1.nombre_pieds)
# lecture d'une variable d'instance
print('chaise1.couleur:', chaise1.couleur)

# lecture d'une variable d'instance si elle existe
# sinonlecture d'une variable de classe
print('chaise2.nombre_pied:', chaise2.nombre_pieds)
# lecture d'une variable d'instance
