...
probability = counter / issues
percentage = probability * 100
print(f"Il y a {percentage:.0f} % de chance d'avoir deux pile avec deux lancers")
...
print(f"Il y a {percentage:.0f} % de chance d'avoir deux pile de suite avec les deux premier lancers sur trois")
...
# Les issues gagnantes d'Alice:
# - face & pile & pile : issue gagnante
# - pile & face & pile : issue gagnante
# - pile & pile & face : issue gagnante
# - pile & pile & pile : issue gagnante
...
for i in range(0, 2):
    for j in range(0, 2):
        for k in range(0, 2):
            issues += 1
            if i == 0 and j == 0 or i == 0 and k == 0 or j == 0 and k == 0 or i == 0 and j == 0 and k == 0:
                counter += 1

probability = counter / issues
percentage = probability * 100

print(f"Il y a {percentage:.0f} % de chance d'avoir deux pile avec trois lancers")